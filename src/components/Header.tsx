      ...
      <div className="container header-container">
        ...
        <div className="header-actions">
          <div className="header-info">
            ...
            <span className="info-text">{SITE_CONFIG.contact.fullAddress}</span>
          </div>
          
          <a href={getWhatsAppLink()} target="_blank" rel="noreferrer" className="btn-primary header-cta" style={{textDecoration: 'none'}}>
