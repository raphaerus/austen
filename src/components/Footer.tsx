import './Footer.css';
import { SITE_CONFIG, getWhatsAppLink } from '../config/siteData';
    ...
    <footer className="footer-section">
      <div className="container">
        <div className="footer-cta">
          ...
          <p>Fale com a {SITE_CONFIG.company.name} e descubra como podemos ajudar seu negócio a crescer reduzindo custos operacionais em escala.</p>
          
          <div className="footer-actions">
            <a href={getWhatsAppLink()} target="_blank" rel="noreferrer" className="btn-primary" style={{textDecoration: 'none'}}>
        ...
        <div className="footer-copyright">
          <p>&copy; {new Date().getFullYear()} {SITE_CONFIG.company.name}. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
